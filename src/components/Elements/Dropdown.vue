<template>
    <Listbox as="div" v-model="selected">
        <ListboxLabel class="block text-sm font-medium leading-6 text-dark-grey">Platform</ListboxLabel>
        <div class="relative mt-2">
            ...
            <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100"
                ...
                <ListboxOptions
                    ...
                    <ListboxOption as="template" v-for="item in platform" :key="item.id" :value="item"
