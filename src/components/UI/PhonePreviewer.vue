<template>
    <svg width="308" height="632" viewBox="0 0 308 632" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <foreignObject v-if="true" x="101.5" y="60.5" width="104" height="104" r="48">
...
const dummyAmount = computed(() => {
  return AllPreviewBtn.length > 5 ? 0 : Array.from({ length: 5 - AllPreviewBtn.length }, (_, index) => index + 1)
})
